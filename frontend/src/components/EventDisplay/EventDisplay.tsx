...
const EMPTY_QUOTES = [
  ...
  '예술은 생각의 눈이다',
  '음악은 인간의 마음을 통해 말할 수 없는 감정을 표현한다',
  '음악은 마음을 위로하고 용기를 주는 친구이다',
  '음악은 영혼의 말이다',
  '음악은 언어 보다 더 큰 언어이다',
  '상상력은 지식 보다 중요하다',
  ...
  '상상할 수 있는 모든 것이 현실이다',
  '예술은 거짓을 통해 진실을 드러낸다',
  '바깥을 보는 자는 꿈을 꾸고, 안을 보는 자는 깨어난다',
  '당신이 무의식을 인식하게 될 때까지, 당신의 삶을 인도할 것이고, 당신은 그것을 운명이라고 부를 것이다',
  '무의식이 의식과의 관계에서 받아들여질 때, 인간은 전체로서 존재하게 된다',
  '무의식은 억압된 감정성향이 모여 있는 장소로, 의식화하지 않으면 우리 행동을 지배할 수 있다',
  '일생의 특권은 진정한 나 자신이 되는 것이다',
  '무의식적인 것과 대면할 용기가 없다면, 우리는 진정 자유로워질 수 없다',
  '그림자 없는 빛은 없으며, 무의식 없는 의식도 없다',
  '당신이 외면하는 것은, 당신을 지배할 것이다',
  '자아가 무의식과의 싸움에서 이겨야만, 진정한 통합이 이루어진다',
  '무의식은 진실로 창조적이며, 무한한 잠재력을 가진 창조의 원천이다',
  '무의식은 모든 예술의 근원이다, 그것은 창조적인 영감의 보고이다',
];
